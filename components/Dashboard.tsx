...
import { TrendingUp, CheckCircle2, AlertCircle, Sparkles, FileText, X, Download, LayoutTemplate } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ goals }) => {
  ...
  const categoryData = useMemo(() => {
    ...
    return Object.keys(groups).map(cat => ({
        ...
        fullName: cat,
        progress: Math.round(groups[cat].total / groups[cat].count),
