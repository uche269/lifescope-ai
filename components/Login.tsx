...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[30%] right-[30%] w-[300px] h-[300px] bg-blue-900/10 rounded-full blur-[80px] animate-pulse" style={{ animationDuration: '5s' }}></div>

            <div className="glass-panel p-8 md:p-12 rounded-3xl w-full max-w-md text-center border-t border-white/10 shadow-2xl shadow-indigo-500/5 relative z-10 animate-page-enter">
                ...
                <h1 className="text-3xl font-bold glow-text mb-3">LifeScope AI</h1>
